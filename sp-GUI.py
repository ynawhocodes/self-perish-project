...
def saveUrl(_urlEntryList):
    for i in linkImageNum:   
        print(_urlEntryList[int(i)].get())
        # url[int(i)] = _urlEntryList[int(i)].get()
        # print(url[int(i)])
...
def inputUrl():
    ...
    for i in linkImageNum:     
        ...
        urlEntryList[int(i)] = Entry(url_window, width=64)
...
window.geometry("300x150+1200+500")
